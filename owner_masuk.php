...
<head>
    ...
    <title>Restock Barang - Matahari Motor Group (Owner)</title>
...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-success">
    ...
    <a class="navbar-brand" href="owner_dashboard.php">Matahari Motor Group</a>
...
<div id="layoutSidenav">
        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link active" href="owner_masuk.php"><div class="sb-nav-link-icon"><i class="fas fa-download"></i></div>Restock Barang</a>
    ...
    <div id="layoutSidenav_content">
        <main class="container-fluid px-4 mt-4">
            <h1 class="mb-4">Restock Barang Manager</h1>
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-download"></i> Data Restock Barang
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            while ($data = mysqli_fetch_array($ambilsemuadatastock)) {
                                ...
                                $jenistransaksi = $data['jenistransaksi'] ?? 'Restock Barang';
                            ?>
                            <tr>
                                <td><?= $i++; ?></td>
                                <td><?= $tanggal; ?></td>
