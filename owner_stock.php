...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-success">
    <a class="navbar-brand" href="owner_stock.php">Matahari Motor Group</a>
...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        <main class="container-fluid px-4 mt-4">
            <h1 class="mb-4">Stock Barang Manager</h1>
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-box"></i> Data Stock Barang
                </div>
                <div class="card-body">
                    <?php
                    ...
                    <div class="alert alert-danger alert-dismissible fade show">
                        <strong>PERHATIAN!</strong> Stock <b><?= $barang; ?></b> telah habis.
