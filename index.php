...
<head>
    ...
    <title>Stock Barang - Matahari Motor Group</title>
...
<div id="layoutSidenav">
        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link active" href="index.php"><div class="sb-nav-link-icon"><i class="fas fa-box"></i></div>Stock Barang</a>
    ...
    <div id="layoutSidenav_content">
        <main class="container-fluid px-4 mt-4">
            <h1 class="mb-4">Stock Barang</h1>
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span><i class="fas fa-box"></i> Data Stock Barang</span>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td><?= $supplier; ?></td>
                                <td>
                                    <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#edit<?= $idb; ?>"><i class="fas fa-edit"></i></button>
                                    <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete<?= $idb; ?>"><i class="fas fa-trash"></i></button>
                                </td>
                            </tr>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <select name="namasupplier" class="form-control" required>
                                                    ...
                                                    while ($s = mysqli_fetch_array($getsupplier)) {
                                                        $selected = ($s['namasupplier'] == $supplier) ? 'selected' : '';
                                                        echo '<option value="'.$s['namasupplier'].'" '.$selected.'>'.$s['namasupplier'].'</option>';
                                                    }
                                                    ?>
                                                </select>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="post">
                <div class="modal-body">
                    <label>Nama Barang</label>
                    <input type="text" name="namabarangbaru" placeholder="Nama Barang Baru" class="form-control" required>
                    <label class="mt-2">Deskripsi</label>
                    <input type="text" name="deskripsibaru" placeholder="Deskripsi" class="form-control" required>
                    <label class="mt-2">Jumlah Stok</label>
                    <input type="number" name="qty" placeholder="Jumlah Stok" class="form-control" required>
                    <label class="mt-2">Supplier</label>
                    <select name="namasupplier" class="form-control" required>
                        <option value="">Pilih Supplier...</option>
                        <?php
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success" name="tambahstok">Tambah</button>
                </div>
            </form>
        </div>
    </div>
