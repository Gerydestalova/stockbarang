...
<div id="layoutSidenav">
        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link active" href="owner_keluar.php"><div class="sb-nav-link-icon"><i class="fas fa-upload"></i></div>Barang Keluar</a>
    ...
    <div id="layoutSidenav_content">
        <main class="container-fluid px-4 mt-4">
            <h1 class="mb-4">Barang Keluar Manager</h1>
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-upload"></i> Data Barang Keluar
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                            <?php
                            $ambilsemuadatastock = mysqli_query($conn, "SELECT k.*, s.namabarang FROM keluar k JOIN stock s ON s.idbarang = k.idbarang");
                            $i = 1;
