...
<div id="layoutSidenav">
        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link active" href="owner_laporan.php"><div class="sb-nav-link-icon"><i class="fas fa-file-alt"></i></div>Laporan</a>
    ...
    <div id="layoutSidenav_content">
        <main class="container-fluid px-4 mt-4">
            <h1 class="mb-4">Laporan Barang Manager</h1>
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-file-alt"></i> Filter Laporan
                </div>
                <div class="card-body">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-box"></i> Ringkasan Stok per Barang
                </div>
